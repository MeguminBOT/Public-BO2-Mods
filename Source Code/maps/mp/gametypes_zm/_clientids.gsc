...
init_custom_zm_powerups_gsc_exclusive_dvars()
{
	...
	level.cmPowerupFieldLifetime = getDvarIntDefault( "cmPowerupFieldLifetime", 10 );
	...
	level.cmPowerupNukeMaxTimeToKill = getDvarFloatDefault( "cmPowerupNukeMaxTimeToKill", 0.2 );
